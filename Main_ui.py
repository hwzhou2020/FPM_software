...
class Ui_FPMSoftware(object):
    ...
    def retranslateUi(self, FPMSoftware):
        ...
        self.actionSystem_Spec.setText(QCoreApplication.translate("FPMSoftware", u"Exit", None))
        ...
        self.actionSave_Messgaes.setText(QCoreApplication.translate("FPMSoftware", u"Export Messages", None))
